...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var{h:qt,classNames:jl,createRef:Ai}=omii,je=null;document.addEventListener("click",e=>{je&&je.hide()});var Bt,Ut,ie,Je,Qt,Eo,et,Qe=class extends h{constructor(){super(...arguments);m(this,ie);m(this,Qt);m(this,Bt,Ai());m(this,Ut,Ai());m(this,et,!1)}get $menu(){return d(this,Bt).current}setPosition(){let{placement:t,offset:o,strategy:i}=this.$props;Wt(d(this,Qt,Eo),this.$menu,{strategy:i,placement:t,middleware:[vt(),xt(),yt(o)]}).then(({x:s,y:r,placement:a})=>{Object.assign(this.$menu.style,{left:`${s}px`,top:`${r}px`})})}show(){g(this,et,!0),d(this,ie,Je).focus(),d(this,ie,Je).setAttribute("aria-expanded",!0),d(this,ie,Je).classList.add("show"),Object.assign(this.$menu.style,{display:"block",position:this.$props.strategy}),je=this,this.setPosition()}hide(){g(this,et,!1),d(this,ie,Je).classList.remove("show"),d(this,ie,Je).setAttribute("aria-expanded","false"),je=null,Object.assign(this.$menu.style,{display:"none"})}toggle(){d(this,et)?this.hide():this.show()}installed(){d(this,Qt,Eo).addEventListener("click",t=>{je&&je!=this&&je.hide(),this.toggle(),t.preventDefault(),t.stopPropagation()}),this.addEventListener("click",t=>{t.stopPropagation()})}render(t){let{menu:o}=this.$props;return qt(qt.f,null,qt("slot",{ref:d(this,Ut)}),qt("slot",{name:"menu",ref:d(this,Bt)},o))}};Bt=new WeakMap,Ut=new WeakMap,ie=new WeakSet,Je=function(){return d(this,Ut).current},Qt=new WeakSet,Eo=function(){let t=d(this,ie,Je).assignedElements();if(t.length===0){let{reference:o}=this.$props;return typeof o=="string"?this.getRootNode()?.querySelector(o):o?.current??o}else return t.at(0)},et=new WeakMap,l(Qe,"css",[()=>v("reboot","utilities","transitions","dropdown"),Pi]),l(Qe,"defaultProps",{placement:"bottom",strategy:"absolute",trigger:"click",offset:0,menu:null,reference:null}),l(Qe,"propTypes",{placement:String,strategy:String,trigger:String,offset:Number});var Mi=`
:host {
  display: block;
  height: 100%;
  width: 100%;
